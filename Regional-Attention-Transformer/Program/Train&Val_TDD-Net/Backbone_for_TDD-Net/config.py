...
def get_args_parser():
    ...
    # load data
    # =============================================================================
    parser.add_argument('--data_foloder', type=str, default='./TDD_dataset/convert_data/',
    ...
    parser.add_argument('--load_backbone_ckpt',type=str, default='ckpt/'+'epoch_5_backbone_trainloss_12.24_valloss_17.29',
    ...
    parser.add_argument('--segmentation_lr',type=float, default=1e-4,
                        help='learning rate for optimizer')
    parser.add_argument('--segmentation_min_lr',type=float, default=1e-5,
                        help='smallest learning rate for warm up')
    
    parser.add_argument('--clamp_lr',type=float, default=1e-7,
                        help='the clamp learning rate to this minimum learning rate')
    ...
    parser.add_argument('--difficut_weight',type=float, default=2,
                        help='Weighted difficulty training object')
    
    parser.add_argument('--training_mode',type=str, default='backbone',# segmentation or backbone
    ...
    parser.add_argument('--not_show_list',type=list, default=['confusion_matrix',"S_confusion_matrix","C_confusion_matrix"],
                        help='when print logger, information in this list ignore it')
    
    parser.add_argument('--not_smooth_list',type=list, default=['blr','slr'],
                        help='when print logger, information in this list ignore it')
    # =============================================================================
    parser.add_argument('--batch_size',type=int, default=4,
                        help='batch size for load [batch_size] data at once')
    
    parser.add_argument('--model_out_size',type=int, default=640/40,
